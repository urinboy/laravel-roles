...
<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Form for creating new buildings') }}</flux:subheading>
...
@else
    <div class="text-red-500 p-4">{{ __("You do not have permission to create buildings.") }}</div>
@endcan
