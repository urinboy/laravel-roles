                ...
                <tbody>
                    @forelse ($buildings as $building)
                        <tr
                            ...
                            <td class="px-4 py-3 sm:px-6 text-gray-600 dark:text-gray-300">{{ $building->name }}</td>
                            <td class="px-4 py-3 sm:px-6 text-gray-600 dark:text-gray-300 break-all">{{ $building->description }}
                            </td>
                            <td class="px-4 py-3 sm:px-6 flex flex-col sm:flex-row gap-2">
                                ...
                                <button wire:click="delete({{ $building->id }})"
                                    wire:confirm="Are you sure you want to delete this building?"
