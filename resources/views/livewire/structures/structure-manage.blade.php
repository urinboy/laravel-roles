            ...
            <div class="px-7 pt-7 pb-2">
                ...
                <form wire:submit.prevent="{{ $actionType === 'delete' ? 'delete' : 'save' }}">
                    @if ($actionType === 'delete')
                        <p class="mb-2 text-gray-800">Are you sure you want to delete this
                            ...
                            <div class="mb-4">
                                ...
                                <select wire:model="assign_person_id"
                                    ...
                                    @php
                                        ...
                                        $assignedPersonIds = $currentRoom
                                            ? $currentRoom->responsiblePeople->pluck('id')->toArray()
                                            : [];
                                    @endphp
                                ...
                                @error('assign_person_id')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                                @error('assign_person_room_id')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-md border border-gray-200">
                    <div class="p-4 flex justify-between items-center cursor-pointer"
                        ...
                        <div class="flex items-center">
                            <div class="w-10 h-10 rounded-lg bg-purple-100 flex items-center justify-center mr-2">
